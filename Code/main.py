...
df = df.dropna(subset=["CountryName", 'Date']).fillna(0)
features = [*best_features, *best_features2, "AverageTemperature"]
...
final_output2.to_csv("final_output.csv")
ouput_coefficients.to_csv("ouput_coefficients.csv")